# doQumentation — Schwäbisch (Swabian)

This is a deployment repository for [swg.doqumentation.org](https://swg.doqumentation.org), the Schwäbisch (Swabian) version of [doQumentation](https://doqumentation.org).
